---
description: Build and manage Telegram bots via the Telegram Bot API. Create bots,
  send messages, handle webhooks, manage groups and channels.
...
Build and manage Telegram bots directly from OpenCngsm.
